...
method
A grade entry must also be able to generate how many points it is worth

Grade : course identifier, course weight, course grade
...
Design and implement class NumericGrade.
