...
class SubtractSquareState(GameState):
    ...
    def __repr__(self):
        ...
        >>> s
        SubtractSquareState('p1', 17)
        '''
        return 'SubtractSquareState({}, {})'.format(repr(self.next_player),
                                                    repr(self.current_total))
    ...
    def __eq__(self, other):
        ''' (SubtractSquareState, SubtractSquareState) -> bool
    ...
    def possible_next_moves(self):
        ...
        >>> s1 = SubtractSquareState('p1', current_total=17)
        >>> s1.possible_next_moves()
        [SubtractSquareMove(1), SubtractSquareMove(4), \
