...
if __name__ == '__main__':
    ...
    dir_name = 'signature_files' #get_valid_directory_name(prompt)
    
    filee_name = ['mystery1.txt', 'mystery2.txt', 'mystery3.txt', 'mystery4.txt', 'mystery5.txt']
    
    for item in filee_name:
        mystery_filename = item
        print(item)
        
        # Every file in the dir_name directory must be a linguistic signature. 
        # We assume there is a minimum of one file.
        files = os.listdir(dir_name)[1:]
